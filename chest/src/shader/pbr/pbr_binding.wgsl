...
#import aurora::pbr::pbr_type::{AreaLight, Camera, DirectionalLight, PbrMaterial, PointLight, SpotLight}
...
@group(1) @binding(3) var<storage, read> area_lights: array<AreaLight>;
@group(1) @binding(4) var<storage, read> area_light_vertices: array<vec3f>;
